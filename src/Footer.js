    ...
    <footer>
      <div className="footer">
        ...
        <div className="coded">
          ...
          >
            {" "}
            <strong>Priyal Dalal </strong>
          </a>
          | Hosted on
          <a
            href="https://app.netlify.com/sites/dictionary-pd/overview"
            className="netlifyLink"
            rel="noopener noreferrer"
            target="_blank"
          >
            {" "}
            <strong>Netlity</strong>
          </a>
        </div>
        <div className="links">
          ...
          <span className="github">
            <a
              href="https://github.com/Priyaldalal30/dictionary-react"
              target="_blank"
              rel="noopener noreferrer"
